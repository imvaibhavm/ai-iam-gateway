...
public final class GitHubMockTools {
    ...
    public static class SearchCode implements ToolHandler {
        ...
        public Object execute(Map<String,Object> args) { return Map.of("matches", 2, "files", java.util.List.of("src/PaymentService.java", "src/PaymentServiceTest.java")); }
    }
    @Component
    public static class ReadFile implements ToolHandler {
        ...
        public Object execute(Map<String,Object> args) { return Map.of("path", args.getOrDefault("path", "PR #382 diff"), "summary", "Mock review passed: tests and authorization checks present."); }
    }
    @Component
    public static class MergePullRequest implements ToolHandler {
        ...
        public Object execute(Map<String,Object> args) { return Map.of("merged", true, "pullRequest", args.getOrDefault("pullRequest", 382), "mode", "deterministic-mock"); }
    }
}
