...
public record IdentityContext(
    ...
    public IdentityContext(String subject, String email, String tenantId, UserRole role) {
        this(subject, email, tenantId, role, IdentityType.HUMAN, null, Set.of(), Map.of());
    }
    ...
    public IdentityContext withRole(UserRole effectiveRole) {
        return new IdentityContext(subject, email, tenantId, effectiveRole, type, delegatedBy, scopes, attributes);
    }
}
